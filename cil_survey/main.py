...
def setup_parser():
    ...
    parser.add_argument('--dataset', '-dataset', type=str, default="cifar100")
    parser.add_argument('--memory_size','-ms',type=int, default=0)
    parser.add_argument('--memory_per_class', '-mps', type=int, default=0)
    ...
    parser.add_argument('--prefix','-p',type=str, help='exp type', default='auc', choices=['benchmark', 'fair', 'auc'])
