...
def timestep_embedding(timesteps, dim, max_period=10000):   # dim 128
    """
    ...
    """
    args = timesteps[:, None].float() * freqs[None]  # [16 64]
    embedding = th.cat([th.cos(args), th.sin(args)], dim=-1) # [16 128]
    if dim % 2:
